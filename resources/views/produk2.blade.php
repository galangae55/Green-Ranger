...
<section class="section-wrap pb-40 single-product">
  <div class="container-fluid semi-fluid">
    ...
    <h1 class="product-title">Topi Rajut Wanita</h1>
    <span class="price">
        <ins><span class="amount">Rp 199.999</span></ins>
    </span>
    <p class="short-description">Topi rajut wanita ini terbuat dari serat kapas daur ulang yang diproses dengan hati-hati untuk menghasilkan benang rajut yang kuat dan lembut. Bahan daur ulang ini memberikan kenyamanan maksimal sambil tetap menjaga kualitas dan ketahanan produk.
         Dapatkan tampilan modis yang ramah lingkungan, dengan topi yang didesain khusus untuk melengkapi berbagai gaya dan kesempatan.</p>

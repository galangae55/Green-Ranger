...
<section class="section-wrap pb-40 single-product">
  <div class="container-fluid semi-fluid">
      ...
      <div class="col-md-6 col-xs-12 product-slider mb-60">
        ...
        <div class="flickity flickity-slider-wrap mfp-hover" id="gallery-main">
          ...
          <div class="gallery-cell">
            <a href="img/shop/item11.jpg" class="lightbox-img">
    ...
    <h1 class="product-title">Gayung Batokk Kelapa</h1>
    <span class="price">
        <ins><span class="amount">Rp 20.000</span></ins>
    </span>
    <p class="short-description">Gayung ini dibuat dari batok kelapa yang diproses ulang untuk memberikan produk yang kuat dan kokoh.
         Dengan desain tradisional yang unik, gayung ini sangat ideal untuk penggunaan sehari-hari, baik untuk mandi atau keperluan lainnya, sambil memberikan nilai tambah sebagai produk ramah lingkungan yang berbahan alami.
    </p>

...
<section class="section-wrap pb-40 single-product">
  <div class="container-fluid semi-fluid">
    ...
    <h1 class="product-title">Tottebag Denim</h1>
    <span class="price">
        <del><span>Rp 500000</span></del>
        <ins><span class="amount">Rp 233.000</span></ins>
    </span>
    <p class="short-description">Totebag denim ini terbuat dari kain denim daur ulang yang diproses ulang untuk memberikan kualitas yang setara dengan kain baru, namun dengan jejak lingkungan yang lebih rendah.
        Setiap totebag memiliki keunikan tersendiri, memberikan nuansa kasual yang stylish sekaligus praktis. Ideal untuk digunakan sehari-hari, totebag ini menawarkan daya tampung yang besar, cocok untuk berbelanja atau membawa barang-barang pribadi.
    </p>
        ...
        <div id="owl-related-items" class="owl-carousel owl-theme">
          ...
          <div class="product">
              <div class="product-item hover-trigger">
                ...
                <span class="price">
                  <ins>
                    <span class="amount">Rp 299.000</span>
                  </ins>
                </span>
              </div>
            </div>

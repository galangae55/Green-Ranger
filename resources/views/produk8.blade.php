...
<section class="section-wrap pb-40 single-product">
  <div class="container-fluid semi-fluid">
    ...
    <h1 class="product-title">Hiasan Kepala Binatang</h1>
    <span class="price">
        <ins><span class="amount">Rp 499.999</span></ins>
    </span>
    <p class="short-description">Hiasan dinding berbentuk kepala hewan ini terbuat dari besi bekas yang diolah menjadi karya seni unik dan estetis. Dengan gaya industrial yang kuat, dekorasi ini menambah karakter dan dimensi pada dinding Anda,
         sambil mendukung keberlanjutan dengan memanfaatkan bahan bekas yang diproses ulang.</p>
        ...
        <div id="owl-related-items" class="owl-carousel owl-theme">
          ...
          <div class="product">
            <div class="product-item hover-trigger">
              ...
              <div class="product-details">
                <h3 class="product-title">
                  <a href="/produk7">Lampu Hias Botol</a>
                </h3>
                <span class="category">
                  <a href="catalogue-grid.html">Perabotan</a>
                </span>

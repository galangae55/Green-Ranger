...
<section class="section-wrap pb-40 single-product">
  <div class="container-fluid semi-fluid">
    ...
    <h1 class="product-title">Topi Rajut Pria</h1>
    <span class="price">
        <del><span>Rp 730.000</span></del>
        <ins><span class="amount">Rp 159.999</span></ins>
    </span>
    <p class="short-description">Topi rajut pria ini dibuat dengan bahan serat daur ulang yang ramah lingkungan. Serat PET daur ulang dari botol plastik bekas yang diproses menjadi benang rajut berkualitas.
        Topi ini tidak hanya memberikan kenyamanan dan gaya, tetapi juga mendukung gerakan keberlanjutan dengan menggunakan bahan yang ramah lingkungan dan mengurangi limbah plastik. Desainnya yang simpel dan elegan cocok untuk aktivitas sehari-hari.

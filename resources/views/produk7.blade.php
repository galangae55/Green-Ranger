...
<section class="section-wrap pb-40 single-product">
  <div class="container-fluid semi-fluid">
    ...
    <h1 class="product-title">Lampu Botol</h1>
    <span class="price">

        <ins><span class="amount">Rp 800.000</span></ins>
    </span>
    <p class="short-description">Lampu dekoratif ini terbuat dari botol kaca bekas yang diubah menjadi karya seni fungsional. Setiap lampu memancarkan cahaya lembut yang menambah sentuhan artistik dan elegan di rumah Anda,
        sementara juga memberikan manfaat ekologis dengan memanfaatkan kembali botol kaca yang sudah tidak terpakai.</p>

...
<section class="section-wrap pb-40 single-product">
  <div class="container-fluid semi-fluid">
      ...
      <div class="col-md-6 col-xs-12 product-slider mb-60">
        ...
        <div class="flickity flickity-slider-wrap mfp-hover" id="gallery-main">
          ...
          <div class="gallery-cell">
            <a href="img/shop/item10.jpg" class="lightbox-img">
    ...
    <h1 class="product-title">Peralatan Makan Kayu</h1>
    <span class="price">
        <ins><span class="amount">Rp 50.000</span></ins>
    </span>
    <p class="short-description">Terbuat dari kayu daur ulang, memberikan sentuhan alami dan ramah lingkungan pada setiap hidangan.
        Dengan desain ergonomis dan kekuatan yang tahan lama, sendok ini cocok untuk penggunaan sehari-hari dan memberikan nuansa alami yang indah pada meja makan Anda.
    </p>
